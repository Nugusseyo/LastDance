...
{
    /// <summary>맵 위의 한 지점. 씬에 놓고 MapData와 종류만 물려주면 스스로 등록한다. 좌표를 에셋에 굽지 않는 이유는 런타임에 맵이 바뀌기 때문이다.</summary>
    public class MapPosition : MonoBehaviour
    {
        ...
        /// <summary>이 지점의 종류. 종류가 고정된 파생 클래스는 이걸 덮어써서 인스펙터 설정을 없앨 수 있다.</summary>
